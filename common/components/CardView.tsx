...
const CardView = (props: any) => {
  ...
  const getStatusList = async () => {
    axios
      .post("https://hgsonsapp.hgsons.in/master/order_status_dropdown.php", {
        UserType: 1,
  ...
  const getNotifyList = async () => {
    axios
      .post("https://hgsonsapp.hgsons.in/master/party_list.php", {
    ...
    axios
      .post("https://hgsonsapp.hgsons.in/master/karigar_list.php", {
        UserType: 1,
        Token: await getStoreValue("token"),
      })
      .then((res) => {
  ...
  const onDelete = async () => {
    axios
      .post("https://hgsonsapp.hgsons.in/master/delete_order.php", {
  ...
  const onUpdate = async () => {
    ...
    axios
      .post("https://hgsonsapp.hgsons.in/master/order_status.php", param)
      .then((res) => {
  ...
  const onNotify = async () => {
    axios
      .post("https://hgsonsapp.hgsons.in/master/order_notify.php", {
        ...
        <View style={styles.cardMain}>
          <View style={styles.dataMain}>
            <View style={{ display: "flex", flexDirection: "column" }}>
              <View style={{ display: "flex", flexDirection: "row" }}>
                ...
                >
                  ...
                  <Text style={styles.data_Value}>{srNo}</Text>
                </View>
                <View
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  <Text style={styles.data_Value}>{orderType}</Text>
                </View>
              </View>
              ...
              <View style={{ display: "flex", flexDirection: "row" }}>
                ...
                >
                  ...
                  <Text style={styles.data_Value}>{OrderNo}</Text>
                </View>
                <View
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  <Text style={styles.data_Value}>{date}</Text>
                </View>
              </View>
            </View>
            <View style={styles.cardImage}>
              {orderData.Image ? (
                <Image
                  source={{ uri: `${imagePath}${orderData.Image[0]}` }}
          ...
          <View style={{ marginLeft: 10, marginTop: 10 }}>
            <View style={{ display: "flex", flexDirection: "row" }}>
              <Text style={styles.datatitle}>{"Party: "}</Text>
              <Text style={styles.data_Value}>{Party}</Text>
            </View>
            <View style={{ display: "flex", flexDirection: "row" }}>
              <Text style={styles.datatitle}>{"Karigar: "}</Text>
              <Text style={styles.data_Value}>{Karigar}</Text>
            </View>
            <View style={{ display: "flex", flexDirection: "row" }}>
              <Text style={styles.datatitle}>{"Item: "}</Text>
              <Text style={styles.data_Value}>{Item}</Text>
            </View>
            <View
              style={{
                display: "flex",
            ...
            >
              ...
              <Text style={styles.data_Value}>{Status}</Text>
            </View>
          </View>
          <View style={styles.actionMain}>
            ...
            >
              <Icon name="edit" size={22} color={"#D4AF37"} />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
                getNotifyList();
              ...
              style={{ marginRight: userType !== "1" ? 30 : 10 }}
            >
              <Icon name="bell" size={22} color={"#D4AF37"} />
            </TouchableOpacity>
            {userType !== "1" && (
              <>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    navigation.navigate("CreateOrder", {
                      userId: orderData.orderId,
                    });
                  }}
                >
                  <Icon name="pencil" size={22} color={"#D4AF37"} />
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => setShowDeleteModal(true)}
                  style={{ marginRight: 20 }}
                >
                  <Icon name="trash" size={22} color={"#D4AF37"} />
                </TouchableOpacity>
              </>
            )}
          </View>
        ...
        <View style={[styles.cardMain, styles.orderCardMain]}>
          <View style={styles.dataMain}>
            ...
            <View style={styles.cardImage}>
              {orderData.Image !== "" ? (
                <Image
                  source={{ uri: `${imagePath}${orderData.Image}` }}
                  style={{ width: "100%", height: "100%" }}
                  alt="Alternate Text"
                />
              ) : (
