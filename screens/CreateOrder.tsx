...
const CreateOrder = (props: any) => {
  ...
  useEffect(() => {
    const getDropdownList = async () => {
      ...
      axios
        .post("https://hgsonsapp.hgsons.in/master/item_list.php", {
          UserType: 1,
          Token: await getStoreValue("token"),
        })
        .then((res) => {
  ...
  useEffect(() => {
    const getOrderData = async () => {
      if (props?.route?.params?.userId !== undefined) {
        axios
          .post("https://hgsonsapp.hgsons.in/master/read_order.php", {
            OrderId: props.route.params.userId,
            Token: await getStoreValue("token"),
          })
          .then((res) => {
  ...
  const onCreateOrder = async (data: any) => {
    ...
    if (props?.route?.params?.userId === undefined) {
      axios
        .post("https://hgsonsapp.hgsons.in/master/create_order.php", param)
        .then((res) => {
      ...
      axios
        .post("https://hgsonsapp.hgsons.in/master/edit_order.php", param)
        .then((res) => {})
        .catch((err) => {
          console.log("err", err);
        });
    ...
    <SafeAreaView style={{ paddingBottom: 0, flex: 1 }}>
      <View style={{ flex: 1, backgroundColor: "#FFFAF0" }}>
        <View style={styles.Title}>
          <Text style={{ fontSize: 22, fontWeight: "800", color: "#28282B" }}>
        ...
        <ScrollView>
          ...
          >
            ...
            <View style={[styles.dataMain, styles.doubleValue]}>
              ...
              <TouchableOpacity
                style={styles.inputBox}
                onPress={() => setShowReminderDate(true)}
              >
                <TextInput
          ...
          <View style={styles.dataMain}>
            ...
            <View style={[styles.inputBox, styles.upload]}>
              ...
              <TouchableOpacity style={styles.uploadBtn} onPress={openGallery}>
                <Text style={{ color: "#FDBD01", fontWeight: "bold" }}>
                  {"upload"}
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.saveBtn}>
            ...
            >
              <Text
                style={{ color: "#FDBD01", fontWeight: "bold", fontSize: 16 }}
              >
                {"Save"}
              </Text>
            </TouchableOpacity>
